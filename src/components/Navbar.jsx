...
// // Import your logo using a relative path from the components folder
...
//         {/* --- DESKTOP LINKS (No Underline + Cursor Pointer) --- */}
//         <nav className="hidden md:flex items-center gap-8">
//           {navItems.map((item) => (
//             <button
//               key={item.id}
//               onClick={() => scrollToSection(item.id)}
//               className={`font-montserrat text-xs tracking-[0.15em] transition-all duration-300 py-2 cursor-pointer
//                 ${
//                   activeSection === item.id
//                     ? "font-medium text-brand-gold"
//                     : "font-light text-brand-gold/50 hover:text-brand-gold"
//                 }
//               `}
//             >
//               {item.label}
...
//                 activeSection === item.id
//                   ? "font-medium text-brand-gold"
//                   : "font-light text-brand-gold/40 hover:text-brand-gold"
//               }
//             `}
//           >
//             {item.label}
...
const Navbar = () => {
  ...
  {/* 🛠️ స్క్రోల్ ఆఫ్‌సెట్ బగ్‌ను పూర్తిగా ఫిక్స్ చేసిన స్మార్ట్ ఫంక్షన్ */}
  const scrollToSection = (id) => {
    if (id === "home") {
      // హోమ్ క్లిక్ చేస్తే ఎటువంటి కన్ఫ్యూజన్ లేకుండా ఖచ్చితంగా స్క్రీన్ అబ్సల్యూట్ టాప్ (0,0) కి తీసుకెళ్తుంది
    ...
    const element = document.getElementById(id);
    if (element) {
      // నెవ్‌బార్ హైట్ h-20 అంటే 80 పిక్సెల్స్. 
      // మిగతా సెక్షన్లు నెవ్‌బార్ కింద దాక్కునిపోకుండా ఈ 80px ఆఫ్‌సెట్ పక్కాగా కాపాడుతుంది
