    ...
    >
      ...
      <div className="absolute inset-y-0 right-0 w-full md:w-1/2 lg:w-3/6 xl:w-3/7 z-0 hidden md:block">
        <img
          ...
          decoding="async"
          className="w-full h-full object-cover object-top md:object-end transition-all duration-500"
        />
        {/* Left Smooth Fade Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-brand-dark via-brand-dark/30 to-transparent z-10" />
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="max-w-xl text-left flex flex-col items-center md:items-start">
          ...
          <div className="block md:hidden mb-8 relative">
            ...
            <div className="w-50 h-50 rounded-full overflow-hidden border-2 border-brand-gold/40 relative z-10]">
              <img
                src={aboutProfile}
                alt="Jayakrishna Profile Mobile"
                decoding="async"
                // {/* 🛠️ మొబైల్ ఇమేజ్ కి కూడా ఫిల్టర్స్ అన్నీ తీసేసి ఒరిజినల్ లుక్ ఇచ్చాము */}
